...
from kubeflow.fairing.builders.cluster import ClusterBuilder
from kubeflow.fairing.builders import dockerfile
from kubeflow.fairing.constants import constants
from kubeflow.fairing.kubernetes.manager import KubeManager
from nbextender import dockerfile_writer

logger = logging.getLogger(__name__)


class NBClusterBuilder(ClusterBuilder):
    """Builds a Notebook docker image in a Kubernetes cluster.
    """
